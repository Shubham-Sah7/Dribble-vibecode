...
export const filterOptions = [
  ...
  { label: "Built with Claude",    value: "Claude"     },
  { label: "Built with Windsurf",  value: "Windsurf"   },
...
export const topTools = [
  ...
  { name: "Claude",   count: "2.4k", color: "#cc785c" },
  { name: "Windsurf", count: "2.0k", color: "#7c3aed" },
  { name: "Replit",   count: "1.8k", color: "#f26207" },
]
